                ...
                <div class="card-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register') }}">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="name">{{ trans('backpack::base.fullname') }}</label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="u_name">{{ trans('backpack::base.u_name') }}</label>

                            <div>
                                <input type="text" class="form-control{{ $errors->has('u_name') ? ' is-invalid' : '' }}" name="u_name" id="u_name" value="{{ old('u_name') }}">
